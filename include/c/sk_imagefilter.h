...
SK_C_API sk_imagefilter_t* sk_imagefilter_new_runtime_shader(const sk_runtimeshaderbuilder_t* builder, float maxSampleRadius, const char* childShaderNames[], const sk_imagefilter_t* inputs[], int inputCount);
