...
typedef enum {
    ...
    SMPTE_ST_240_SK_COLORSPACE_PRIMARIES_CICP = 7,
    GENERIC_FILM_SK_COLORSPACE_PRIMARIES_CICP = 8,
    REC2020_SK_COLORSPACE_PRIMARIES_CICP = 9,
    SMPTE_ST_428_1_SK_COLORSPACE_PRIMARIES_CICP = 10,
    SMPTE_RP_431_2_SK_COLORSPACE_PRIMARIES_CICP = 11,
    SMPTE_EG_432_1_SK_COLORSPACE_PRIMARIES_CICP = 12,
...
typedef enum {
    ...
    SMPTE_ST_240_SK_COLORSPACE_TRANSFER_FN_CICP = 7,
    ...
    SRGB_SK_COLORSPACE_TRANSFER_FN_CICP = IEC61966_2_1_SK_COLORSPACE_TRANSFER_FN_CICP,
    ...
    SMPTE_ST_428_1_SK_COLORSPACE_TRANSFER_FN_CICP = 17,
