    ...
    const sk_surfaceprops_t* props)
{
    ...
    skgpu::Mipmapped mips = mipmapped ? skgpu::Mipmapped::kYes : skgpu::Mipmapped::kNo;
...
extern "C" SK_C_API bool sk_graphite_texture_info_get_mipmapped(const sk_graphite_texture_info_t* h) {
    return AsGraphiteTextureInfo(h)->mipmapped() == skgpu::Mipmapped::kYes;
}
