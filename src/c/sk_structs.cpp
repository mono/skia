...
// sk_pngencoder_options_t and sk_webpencoder_options_t use manual conversion functions
// instead of reinterpret_cast (C structs don't match C++ structs after m147 fICCProfile removal)
...
static_assert (sizeof (sk_fontarguments_variation_position_coordinate_t) == sizeof (SkFontArguments::VariationPosition::Coordinate), ASSERT_MSG(SkFontArguments::VariationPosition::Coordinate, sk_fontarguments_variation_position_coordinate_t));
static_assert (sizeof (sk_fontarguments_palette_override_t) == sizeof (SkFontArguments::Palette::Override), ASSERT_MSG(SkFontArguments::Palette::Override, sk_fontarguments_palette_override_t));
