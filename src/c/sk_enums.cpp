...
static_assert ((int)skottie::Animation::RenderFlags::kSkipTopLevelIsolation      == (int)SKIP_TOP_LEVEL_ISOLATION,      ASSERT_MSG(skottie::Animation::RenderFlags, skottie_animation_renderflags_t));
static_assert ((int)skottie::Animation::RenderFlags::kDisableTopLevelClipping    == (int)DISABLE_TOP_LEVEL_CLIPPING,    ASSERT_MSG(skottie::Animation::RenderFlags, skottie_animation_renderflags_t));
